<%-- 
    Document   : AgregarCarrito1
    Created on : 10/08/2020, 07:08:17 AM
    Author     : demon
--%>
...
<html>
    ...
    <body>
        ...
        <table border="0" width="800" align="center" >
            ...
            <tr align="center" >
                <td colspan="2" >
                    <h4> <a href="MostrarProductos.jsp" >Mostrar Productos</a> | <a href="AgregarCarrito1.jsp" >Agregar al Carrito</a> | <a href="CerrarSesion" >Cerrar Sesion</a>      </h4>
                </td>
            </tr>
            <tr></tr>
            <tr align="center" >
                <td colspan="2" >
                    <table width="100%" border="0" >
                        <tr bgcolor="#FF6600" style="color:#FFFFFF" >
                            ...
                            <td width="16%" align="right" valing="top" ><h4><span class="Estilo3" >Proceso</span></h4></td>
                        </tr>
                        ...
                        %>
                            <tr>
                                ...
                                <td width="16" align="right" valing="top" > <%=direccion%> </td>
                            </tr>
                        <% } %>
                    </table>
                </td>
